...
CREATE TABLE leads (
    ...
    trial_login_url VARCHAR(255) NULL,
    trial_username VARCHAR(100) NULL,
    trial_password VARCHAR(100) NULL,
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE lead_responses (
    ...
    next_followup DATE,
    status_updated ENUM('new','contacted','interested','not_interested','follow_up','converted','trial','trial_ended') NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
